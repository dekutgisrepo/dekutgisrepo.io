...
L.Control.Zoom = L.Control.extend({
	...
	_createButton: function (html, title, className, container, fn, context) {
		var link = L.DomUtil.create('span', className, container);
		link.innerHTML = html;
		link.href = '#';
		link.title = title;
...
L.Control.Attribution = L.Control.extend({
	options: {
		...
		prefix: '<a href="http://studentmothers.freeorg.com" title="Student initiative Project To alarm on Needs of Student Mothers.">DeKUT STUDENT MOTHERS\' Map.</a>'
	},
